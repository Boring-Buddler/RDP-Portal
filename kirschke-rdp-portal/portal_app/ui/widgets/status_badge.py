...
class StatusBadgeWidget(QLabel):
    ...
    @classmethod
    def for_agent_status(cls, status: AgentStatus, parent: QFrame | None = None) -> "StatusBadgeWidget":
    ...
    @classmethod
    def for_session_state(cls, state: SessionState, parent: QFrame | None = None) -> "StatusBadgeWidget":
    ...
    @classmethod
    def for_manual_flag(cls, flag: ManualFlagType, parent: QFrame | None = None) -> "StatusBadgeWidget":
