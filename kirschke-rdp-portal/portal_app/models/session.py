...
class SessionEvent:
    ...
    def get_display_type(self) -> str:
        ...
        type_names = {
            ...
            EventType.RDP_ACCESS_GRANTED: "Admin: RDP-Zugriff erteilt",
            EventType.RDP_ACCESS_REVOKED: "Admin: RDP-Zugriff entzogen",
            EventType.RDP_ACCESS_SYNC_COMPLETED: "Admin: AD-RDP-Gruppe abgeglichen",
            EventType.RDP_ACCESS_SYNC_FAILED: "Admin: AD-RDP-Abgleich fehlgeschlagen",
