...
class SharePointManager:
    ...
    def _find_item_id(self, workstation_id: str, list_name: str) -> str | None:
    ...
    def delete_workstation(self, workstation_id: str, etag: str | None = None) -> bool:
    ...
    def get_admin_command(self, command_id: str) -> AdminCommandSchema | None:
    ...
    def delete_admin_command(self, command_id: str, etag: str | None = None) -> bool:
    ...
    def get_access_rules(
        self,
        user_or_group_id: str | None = None,
        workstation_id: str | None = None,
    ...
    def delete_access_rule(self, rule_id: str, etag: str | None = None) -> bool:
