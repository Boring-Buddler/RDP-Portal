...
class GraphHTTPClient:
    ...
    def __init__(
        self,
        auth_provider: EntraAuthProvider | None = None,
    ...
    def request(
        ...
        try:
            ...
            raise GraphAPIError("Request timeout", HTTPStatus.REQUEST_TIMEOUT) from e
            ...
            if retry_count < self.config.max_retries:
                ...
                time.sleep(delay)
                return self.request(method, url, params, data, json_data, headers, timeout, retry_count + 1)
            raise GraphAPIError(f"Request failed: {str(e)}", HTTPStatus.INTERNAL_SERVER_ERROR) from e
    ...
    def get(self, url: str, params: dict | None = None, **kwargs) -> GraphResponse[dict]:
        """GET request."""
        return self.request("GET", url, params=params, **kwargs)

    def post(self, url: str, json_data: dict | None = None, data: Any | None = None, **kwargs) -> GraphResponse[dict]:
        """POST request."""
        return self.request("POST", url, json_data=json_data, data=data, **kwargs)

    def put(self, url: str, json_data: dict | None = None, data: Any | None = None, **kwargs) -> GraphResponse[dict]:
        """PUT request."""
        return self.request("PUT", url, json_data=json_data, data=data, **kwargs)

    def patch(self, url: str, json_data: dict | None = None, data: Any | None = None, **kwargs) -> GraphResponse[dict]:
        """PATCH request."""
...
class GraphClient(GraphHTTPClient):
    ...
    def get_users(self, filter: str | None = None, select: list[str] | None = None) -> PaginatedResponse[dict]:
        """Get all users.
    ...
    def get_user_groups(self, user_id: str | None = None) -> PaginatedResponse[dict]:
    ...
    def get_user_photo(self, user_id: str | None = None, size: int = 64) -> GraphResponse[bytes]:
        """Get user photo.
    ...
    def get_groups(self, filter: str | None = None, select: list[str] | None = None) -> PaginatedResponse[dict]:
        """Get all groups.
